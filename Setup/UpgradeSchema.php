            ...
            if ($installer->tableExists('mp_giftcard_history')){
                ...
                if ($installer->tableExists('mp_giftcard_code')){
                    $connect->addForeignKey(
                        $installer->getFkName('mp_giftcard_history', 'giftcard_id', 'mp_giftcard_code', 'giftcard_id'),
                        $installer->getTable('mp_giftcard_history'),
                        'giftcard_id',
                        $installer->getTable('mp_giftcard_code'),
                        'giftcard_id',
                ...
                if ($installer->tableExists('mp_customer_entity')){
                    $connect->addForeignKey(
                        $installer->getFkName('mp_giftcard_history', 'customer_id', 'mp_customer_entity', 'entity_id'),
                        $installer->getTable('mp_giftcard_history'),
                        'customer_id',
                        $installer->getTable('mp_customer_entity'),
                        'entity_id',
                        \Magento\Framework\DB\Ddl\Table::ACTION_CASCADE
                    );
                }
